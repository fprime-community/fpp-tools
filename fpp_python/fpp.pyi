...
class Analysis:
    @property
    def location_specifier_map(self) -> builtins.dict[tuple[SpecLocKind, QualifiedName], SpecLoc]: ...
    @property
    def dictionary_generation(self) -> builtins.bool: ...
    @property
    ...
    @property
    def dictionary_map(self) -> builtins.dict[Symbol, Dictionary]: ...
    @property
    ...
    def get_big_int_value(self, node: AstNode) -> typing.Optional[builtins.int]: ...
    def get_big_int_value_opt(self, expr: typing.Optional[Expr]) -> typing.Optional[builtins.int]: ...
    def get_component(self, id: AstNode) -> typing.Optional[Component]: ...
    def get_component_instance(self, id: AstNode) -> typing.Optional[ComponentInterfaceInstance]: ...
    def get_component_instance_symbol(self, id: AstNode) -> typing.Optional[Symbol]: ...
    def get_dictionary(self, id: AstNode) -> typing.Optional[Dictionary]: ...
    def get_enclosing_names(self, symbol: Symbol) -> builtins.list[builtins.str]: ...
    ...
    def get_interface_instance_symbol(self, id: AstNode) -> typing.Optional[Symbol]: ...
    def get_interface_symbol(self, id: AstNode) -> typing.Optional[Symbol]: ...
    ...
    def get_reason_for_non_displayable_type_at(self, node: AstNode) -> builtins.list[tuple[Span, builtins.str]]: ...
    def get_scope(self, symbol: typing.Optional[Symbol]) -> Scope: ...
    def get_topology(self, id: AstNode) -> typing.Optional[Topology]: ...
...
class CommandEntry:
    @property
    def instance(self) -> ComponentInterfaceInstance: ...
    @property
...
class ComponentInterfaceInstance(InterfaceInstanceBase):
    ...
    def get_port_instance_identifier(self, name: Ident) -> PortInstanceIdentifier: ...
    def __repr__(self) -> builtins.str: ...
...
class Dictionary:
    @property
    def used_symbol_set(self) -> builtins.list[Symbol]: ...
    @property
    def command_entry_map(self) -> builtins.dict[builtins.int, CommandEntry]: ...
    @property
    def tlm_channel_entry_map(self) -> builtins.dict[builtins.int, TlmChannelEntry]: ...
    @property
    def reverse_tlm_channel_entry_map(self) -> builtins.dict[TlmChannelEntry, builtins.int]: ...
    @property
    def event_entry_map(self) -> builtins.dict[builtins.int, EventEntry]: ...
    @property
    def param_entry_map(self) -> builtins.dict[builtins.int, ParamEntry]: ...
    @property
    def record_entry_map(self) -> builtins.dict[builtins.int, RecordEntry]: ...
    @property
    def container_entry_map(self) -> builtins.dict[builtins.int, ContainerEntry]: ...
    @property
    def tlm_packet_set_map(self) -> builtins.dict[builtins.str, TlmPacketSet]: ...
    def find_numeric_id_for_channel(self, t: Topology, channel_id: TlmChannelIdentifier) -> builtins.int: ...
    def __repr__(self) -> builtins.str: ...
...
class ImpliedUse:
    @property
    def annotations(self) -> builtins.list[builtins.str]: ...
    @property
...
class NodeVisitor:
    ...
    * To stop early, raise an exception — return values are not inspected.
    ...
    def visit_TlmChannelIdentifier(self, node: AstNode) -> typing.Any: ...
...
class QualifiedName:
    ...
    @property
    def qualifier(self) -> builtins.list[builtins.str]: ...
    @property
    def to_ident_list(self) -> builtins.list[builtins.str]: ...
    def short_name(self, enclosing_names: typing.Sequence[builtins.str]) -> QualifiedName: ...
    def __repr__(self) -> builtins.str: ...
    def __str__(self) -> builtins.str: ...
...
class SpecTlmPacket(AstNode):
    ...
    def group(self) -> Expr: ...
    @property
    def members(self) -> builtins.list[SpecInclude]: ...
    def __repr__(self) -> builtins.str: ...
...
class SpecTlmPacketSet(AstNode):
    ...
    @property
    def omitted(self) -> builtins.list[AstNode]: ...
    def __repr__(self) -> builtins.str: ...
...
@typing.final
class TlmChannelEntry:
    @property
    def instance(self) -> ComponentInterfaceInstance: ...
    @property
    def tlm_channel(self) -> TlmChannel: ...
    @property
    def qualified_name(self) -> builtins.str: ...
    def __repr__(self) -> builtins.str: ...
...
class TlmChannelIdentifier:
    @property
    def component_instance(self) -> ComponentInterfaceInstance: ...
    @property
    def tlm_channel(self) -> TlmChannel: ...
    @property
    def qualified_name(self) -> builtins.str: ...
